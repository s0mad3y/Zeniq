...
export function ZeniqWebsite({ authControls }: { authControls: React.ReactNode }) {
  ...
  <div className="min-h-screen bg-neutral-950 text-white">
    ...
    <main>
      ...
      <section id="pricing" className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
        ...
        {selectedPlan && (
          <div className="mx-auto mt-12 max-w-3xl rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                <p className="text-sm uppercase tracking-[0.25em] text-white/45">Checkout</p>
                <h3 className="mt-2 text-2xl font-semibold text-white">
                  Activate {selectedPlan}
                </h3>
                <p className="mt-2 text-sm text-white/65">
                  Enter your email address to receive your software activation code, then choose your payment method.
                </p>
              </div>
              <button
                type="button"
                ...
                className="rounded-2xl border border-white/15 bg-white/5 px-4 py-2 text-sm text-white/75 transition hover:bg-white/10"
              >
                Close
              </button>
            </div>
            ...
            <div className="mt-8 grid gap-8 md:grid-cols-[1fr_0.9fr]">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-2xl border border-white/10 bg-neutral-900 px-4 py-3 text-white outline-none transition placeholder:text-white/30 focus:border-white/30"
                />

                <div className="mt-6">
                  <p className="mb-3 text-sm font-medium text-white/80">Payment method</p>
                ...
                <div className="mt-6 rounded-2xl border border-white/10 bg-neutral-900/70 p-4 text-sm text-white/65">
                  {selectedPlan === 'Creator' ? 'Selected plan: Creator — $12/mo' : 'Selected plan: Pro Studio — $30/mo'}
                </div>
              </div>

              <div className="rounded-[1.75rem] border border-white/10 bg-neutral-900 p-6">
                <p className="text-sm uppercase tracking-[0.2em] text-white/45">QR code</p>
                {paymentMethod ? (
                  <>
                    <div className="mt-4 flex h-56 items-center justify-center rounded-[1.5rem] border border-dashed border-white/15 bg-white/5">
                      <Image
                        src={paymentMethod === "Momo" ? "/qr/momo-v3.jpg" : "/qr/bank-v3.jpg"}
                  ...
                  <div className="mt-4 flex h-56 items-center justify-center rounded-[1.5rem] border border-dashed border-white/15 bg-white/5 text-center text-sm text-white/45">
                    Choose Momo or Bank transfer to display the QR code box.
                  </div>
                )}
              </div>
            </div>
